var TWITTERBAR = {
	...
	get version() { 
		if ("@mozilla.org/extensions/manager;1" in Components.classes) {
			return Components.classes["@mozilla.org/extensions/manager;1"].getService(Components.interfaces.nsIExtensionManager).getItemForID("{1a0c9ebe-ddf9-4b76-b8a3-675c77874d37}").version;
		}
		else {
			return "@todo";
		}
